...
public class PageControl extends LinearLayout
{
	...
	private int mActiveColor = 0xff6699ff;
	private int mInacctiveColor = Color.LTGRAY;
	...
	{	
		...
		((ShapeDrawable) activeDrawable).getPaint().setColor( mActiveColor ); //a.getColor(0, mActiveColor)
		((ShapeDrawable) inactiveDrawable).getPaint().setColor(mInacctiveColor); //a.getColor(1, mInacctiveColor)
